...
class MobileReportResourceGroupType(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """MobileReportResourceGroupType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MobileReportResourceGroupType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MobileReportResourceGroupType):
            return False
