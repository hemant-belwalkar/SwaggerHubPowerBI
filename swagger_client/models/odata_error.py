...
class OdataError(object):
    ...
    def __init__(self, error=None, _configuration=None):  # noqa: E501
        """OdataError - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this OdataError.  # noqa: E501


        :return: The error of this OdataError.  # noqa: E501
        :rtype: OdataErrorMain
        """
        return self._error

    @error.setter
    def error(self, error):
        """Sets the error of this OdataError.


        :param error: The error of this OdataError.  # noqa: E501
        :type: OdataErrorMain
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OdataError):
            return False
