...
class ReportParameterType(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """ReportParameterType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReportParameterType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportParameterType):
            return False
