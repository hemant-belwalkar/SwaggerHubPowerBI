...
class KpiSharedDataItemAggregation(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """KpiSharedDataItemAggregation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KpiSharedDataItemAggregation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KpiSharedDataItemAggregation):
            return False
